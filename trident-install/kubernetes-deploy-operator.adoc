...
.Antes de começar
Antes de iniciar a instalação, faça login no host Linux e verifique se ele está gerenciando um sistema operacional em funcionamento link:requirements.html["Cluster compatível com Kubernetes"] e se você possui os privilégios necessários.
