...
----
. Use `helm install` e especifique um nome para sua implantação, como no exemplo a seguir, onde `100.2410.0` está a versão do Trident que você está instalando.
+
[listing]
----
