...
[%collapsible]
====
Para obter mais informações sobre force detach, consulte link:..trident-install/kubernetes-customize-deploy.html["Personalizar a instalação do operador Trident"].
