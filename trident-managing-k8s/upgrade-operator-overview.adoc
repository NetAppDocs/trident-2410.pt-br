...
TIP: Para obter mais informações sobre a arquitetura do Astra Trident no cluster Kubernetes, consulte link:../trident-get-started/intro.html#astra-trident-architecture["Arquitetura do Astra Trident"].
