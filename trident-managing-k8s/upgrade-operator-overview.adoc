...
TIP: Para obter mais informações sobre a arquitetura do Astra Trident no cluster Kubernetes, consulte link:../trident-get-started/architecture.html["Arquitetura da Trident"].
