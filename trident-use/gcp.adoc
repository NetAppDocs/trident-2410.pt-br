...
* *CVS-Performance*: O tipo de serviço Trident padrão. Este tipo de serviço otimizado para desempenho é ideal para cargas de trabalho de produção que valorizam o desempenho. O tipo de serviço CVS-Performance é uma opção de hardware que suporta volumes com tamanho mínimo de 100 GiB. Você pode escolher uma das seguintes opções link:https://docs.cloud.google.com/netapp/volumes/docs/discover/overview["três níveis de serviço"^]:
+
** `standard`
** `premium`
** `extreme`
